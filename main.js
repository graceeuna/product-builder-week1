...
const dinnerMenus = [
    ...
    { name: '비빔밥', description: '다양한 채소와 고명, 고추장을 넣어 비벼 먹는 한국 대표 건강식입니다. 색색의 재료가 조화롭게 어우러져 눈과 입이 즐겁습니다.' },
    { name: '불고기', description: '달콤 짭짤한 양념에 재운 소고기를 구워 먹는 한국 전통 요리입니다. 부드러운 육질과 풍부한 양념 맛이 일품입니다.' },
    { name: '갈비찜', description: '간장 양념에 부드럽게 익힌 갈비찜은 잔치나 특별한 날에 빠지지 않는 고급 한식입니다. 남녀노소 누구나 좋아하는 맛입니다.' },
    // Japanese Food
    { name: '초밥', description: '신선한 해산물과 밥의 완벽한 조화! 입안 가득 바다의 향이 퍼지는 일본 대표 요리입니다. 간장과 와사비를 곁들여 드시면 더욱 맛있습니다.' },
    { name: '라멘', description: '깊고 진한 육수에 쫄깃한 면발, 다양한 고명까지! 일본을 대표하는 면 요리로, 추운 날 따뜻하게 몸을 녹여줍니다.' },
    { name: '돈까스', description: '바삭하게 튀겨낸 돼지고기에 달콤한 소스를 곁들인 일본식 커틀릿입니다. 아이들도 좋아하는 인기 메뉴입니다.' },
    { name: '우동', description: '두툼하고 쫄깃한 면발과 시원한 국물이 특징인 일본 면 요리입니다. 튀김이나 유부를 곁들여 먹으면 더욱 맛있습니다.' },
    { name: '규동', description: '달콤 짭짤한 소고기 덮밥으로, 간단하면서도 든든한 한 끼 식사로 좋습니다. 반숙 계란을 올려 먹으면 더욱 부드럽습니다.' },
    // Western Food
    ...
    { name: '스테이크', description: '육즙 가득한 소고기를 완벽하게 구워낸 서양 요리의 꽃! 특별한 날 분위기를 내기에 좋습니다. 굽기 정도를 선택하여 즐길 수 있습니다.' },
    { name: '햄버거', description: '부드러운 빵 사이에 육즙 가득한 패티와 신선한 채소를 넣어 만든 대표적인 패스트푸드입니다. 간편하지만 든든한 한 끼 식사로 최고입니다.' },
    { name: '샐러드', description: '신선한 채소와 다양한 토핑, 드레싱이 어우러진 건강하고 가벼운 식사입니다. 다이어트나 건강을 생각하는 분들에게 좋습니다.' }
];
